...
#D:\0_complexaton\Challenge4

matrx_worcom_2 <- read.csv("D:/0_complexaton/Challenge4/matrx_worcom_2.txt", row.names=1)
matrx_worcom <- read.csv("D:/0_complexaton/Challenge4/matrx_worcom.cvs", row.names=1)
